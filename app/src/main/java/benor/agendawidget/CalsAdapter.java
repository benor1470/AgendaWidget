...
public class CalsAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final CheckBox itemCheckBox=((CheckBox)convertView.findViewById(R.id.list_cal_checkbox));
		...
		TextView itemText=((TextView)convertView.findViewById(R.id.list_cal_text));
